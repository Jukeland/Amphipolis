...
public class Controller{
        ...
        if(gameFinished()){
            if(numOfPlayers == 4) {
                ...
                if(P1.getPoints() > P2.getPoints())
                    return "The winner is Player 1, with " + P1.getPoints() + " points. The robber's points were: " + P2.getPoints();
                else if(P1.getPoints() < P2.getPoints())
                    return "The winner is the Robber, with " + P2.getPoints() + " points. The Player's points were: " + P1.getPoints();
                else
                    return "The game ended with a tie. Both the Player and the Robber had " + P1.getPoints() + " points.";
            }
        }else return "Game has not finished yet";
    }

    /**
     * <b>Transformer:</b> initializes everything needed for a new game
     * <b>Postcondition:</b> everything needed for a new game has been initialized
     */
    public void newGame(){
        if(numOfPlayers == 4){
            bag.init_tiles();
    ...
    public void assignCaryatidPoints(){
        if(numOfPlayers == 4){
            ...
            P1.initCaryatid();
            P2.initCaryatid();
            if(P1.getCaryatid() != 0 || P2.getCaryatid() != 0){
                if(P1.getCaryatid() > P2.getCaryatid())
                    P1.setPoints(P1.getPoints() + 6);
                else if(P1.getCaryatid() < P2.getCaryatid())
                    P2.setPoints(P2.getPoints() + 6);
            }
        }
    }
    ...
    public void assignSphinxPoints(){
        if(numOfPlayers == 4){
            ...
            P1.initSphinx();
            P2.initSphinx();
            if(P1.getSphinx() > P2.getSphinx())
                P1.setPoints(P1.getPoints() + 6);
            else if(P1.getSphinx() < P2.getSphinx())
                P2.setPoints(P2.getPoints() + 6);
        }
    }
